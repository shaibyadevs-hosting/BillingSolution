...
import {
	...
	isLicenseValid,
	clearLicense,
} from "@/lib/utils/license-manager";
...
export default function LicensePage() {
	...
	if (checking) {
		console.log(
			"[LicensePage] Rendering loading state (checking:",
			checking,
			")"
		);
		return (
			...
			<Card className="w-full max-w-md">
				...
				<CardContent>
					...
					<div className="mt-6 text-center text-sm text-muted-foreground">
						<p>Need a license? Contact support for assistance.</p>
					</div>
					...
					<div className="mt-6 border-t pt-4">
						...
						<p className="mt-2 text-xs text-center text-muted-foreground">
							This will completely remove the license and reset this PC to a new
							installation state. You will need to activate again.
						</p>
					</div>
				</CardContent>
			</Card>
