...
export interface Product { id: string; name: string; sku?: string; category?: string; price: number; cost_price?: number; stock_quantity?: number; unit?: string; hsn_code?: string; gst_rate?: number; is_active?: boolean; selling_unit?: "loose" | "together" | null }
